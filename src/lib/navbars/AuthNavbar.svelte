		...
		>
			<ul class="flex flex-col lg:flex-row list-none mr-auto">
				<li class="flex items-center">
					...
					>
						<i class="lg:text-gray-200 text-gray-400 far fa-file-alt text-lg leading-lg mr-2" />
						Docs
					</a>
				</li>
			</ul>
			<ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
				...
				<li class="flex items-center">
					<a
						...
						target="_blank"
					>
						<i class="lg:text-gray-200 text-gray-400 fab fa-facebook text-lg leading-lg" />
				...
				<li class="flex items-center">
					<a
						...
						target="_blank"
					>
						<i class="lg:text-gray-200 text-gray-400 fab fa-twitter text-lg leading-lg" />
				...
				<li class="flex items-center">
					<a
						...
						target="_blank"
					>
						<i class="lg:text-gray-200 text-gray-400 fab fa-github text-lg leading-lg" />
